...
if __name__ == '__main__':
    batch_size = 8
    num_workers = 0
    train_dataset = DataSet_V2('./datasets/dogcat/training_data', batch_size, True, num_workers)
    test_dataset = DataSet_V2('./datasets/dogcat/testing_data', batch_size, False, num_workers)
